          ...
          <div class="row">
			...
			<?php
				...
				if (isset($_GET['id'])) {
				  ...
				  $stid = oci_parse($koneksi,"SELECT * FROM jurusan WHERE KD_JURUSAN = '$id'");
				  oci_execute($stid);
			...
			<form class="form-horizontal" action="proses_update_jurusan.php" method="post">
			 <div class="form-row">
				  ...
				  <input type="hidden" class="form-control" name="kd_jurusan" value="<?= $d['KD_JURUSAN'] ?>" >
				
				<div class="form-group col-md-6">
				  <label for="">NO_PEMINJAM</label>
				  <input type="text" class="form-control" name="no_peminjam" value="<?= $d['NO_PEMINJAM'] ?>">
				</div>
			  </div>
			  <div class="form-row">
			  <div class="form-group col-md-6">
